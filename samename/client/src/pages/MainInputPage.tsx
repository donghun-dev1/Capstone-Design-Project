...
const MainInputPage: React.FC = () => {
  ...
  // ⭐ 추가: clearSelectedMeals 불러오기
  const { clearSelectedMeals } = useSelectedMealsStore();
  ...
  // ⭐ string | number 둘 다 받는 안전한 핸들러
  const handleMealsPerDayChange = (value: string | number) => {
    const newMealsPerDay = typeof value === "string" ? parseInt(value, 10) : value;
          ...
          <div className="mb-6">
            ...
            <InputCard>
              <ButtonGroup
                ...
                onChange={handleMealsPerDayChange} // ⭐ 여기만 바뀜!
