    ...
    <AppBackground>
      ...
      >
        <MainCard>
              ...
              {nutrientNames.map((n: any) => (
                <SummaryItem key={n.key}>
                  ...
                  <NutrientValue color={getNutrientColor(n.key)}>
                    {summary[n.key as keyof typeof summary].current}/
                    {summary[n.key as keyof typeof summary].target}{" "}
                    {summary[n.key as keyof typeof summary].unit}
                  </NutrientValue>
                  <DetailProgressBar>
                    <ProgressBarInner
          ...
          <CenteredButtonWrapper>
            <MainButton onClick={handleSaveToTxt}>식단 요약 저장하기 (.txt)</MainButton>
          </CenteredButtonWrapper>
        </MainCard>
      </motion.div>
    </AppBackground>
