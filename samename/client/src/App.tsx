...
function Router() {
  return (
    <Switch>
      <Route path="/"> <MainInputPage /> </Route>
      <Route path="/recommend"> <RecommendPage /> </Route>
      <Route path="/recommendations"> <RecommendPage /> </Route>
      <Route path="/configure"> <MealConfigPage /> </Route>
      <Route path="/summary"> <DietResult /> </Route>
